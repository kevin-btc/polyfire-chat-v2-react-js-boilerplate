const UnauthenticatedView = ({ login }: { login: any }) => {
  return (
    <div className="flex h-screen items-center justify-center bg-stone-800">
      <button
        onClick={() => login("github")}
        className="inline-flex items-center rounded-md bg-stone-900 px-4 py-2 text-sm font-medium text-stone-300 hover:bg-stone-700 focus:outline-none focus:ring focus:ring-red-600 focus:ring-opacity-50"
      >
        <svg
